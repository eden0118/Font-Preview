...
export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-stone-50 via-stone-100 to-stone-200 p-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Analysis Card */}
          <Link href="/analysis">
            <div className="group relative overflow-hidden rounded-2xl border-2 border-stone-200 bg-white p-8 transition-all duration-300 hover:border-stone-400 hover:shadow-lg cursor-pointer">
