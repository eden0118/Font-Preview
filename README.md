...
一個現代、快速的字體預覽和分析工具，專為繁體中文使用者設計。當您使用日文或簡體字型時，能快速檢測這些字體對繁體中文的支援程度，避免文字缺字困擾。

## ✨ 核心功能

- **🔍 精準分析** - 上傳任何字型（包括日文、簡體），立即知道它能否完美支援繁體中文
- **⚠️ 缺字提醒** - 智能標記常用繁體漢字的缺失率，掌握使用風險
- **⚖️ 字型比較** - 並排預覽多個字型檔案，快速對比視覺效果和繁中覆蓋率
- **⚡ 即時預覽** - 無需安裝字體到系統，在瀏覽器中即時預覽效果
- **🎨 完整自訂** - 調整字體大小、文字顏色、背景顏色，預覽真實效果
- **📊 多語言覆蓋率** - 同時分析對繁體中文、簡體中文、日文、韓文的支援度
...
2. **檢視分析結果** - 了解字體的繁中適用性
   - **語言覆蓋率** - 繁體中文、簡體中文、日文、韓文支援度一覽
   - **缺字警告** - 如果繁體中文覆蓋率低於 95%，系統會提醒可能的文字缺失
   - **格式檢測** - 自動識別是否為日文、簡體專用字型
   - **字符統計** - 字體包含的總字符數
